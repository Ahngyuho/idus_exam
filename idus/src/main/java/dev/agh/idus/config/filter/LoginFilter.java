...
//                new UserDto.SignupRequest(request.getParameter("username"), request.getParameter("password"));
        try {
            ...
            MemberDto.SignupRequest userDto  = new ObjectMapper().readValue(request.getInputStream(), MemberDto.SignupRequest.class);
